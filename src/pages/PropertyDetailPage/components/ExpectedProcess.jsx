...
const Step = ({ step, icon: Icon, title, description, isLast }) => (
    <div className="relative flex flex-col items-center flex-1 group">
        ...
        <div className="relative z-10 w-14 h-14 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-center mb-6 group-hover:border-emerald-200 transition-colors">
            <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-[#0F172A] text-white text-[10px] font-black flex items-center justify-center border-2 border-white">
                {step}
            </div>
        ...
        <div className="text-center px-4">
            <h4 className="text-sm font-bold text-slate-900 mb-2 uppercase tracking-tight">{title}</h4>
        ...
        <div className="py-12 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden">
            ...
            <div className="relative z-10">
                <div className="text-center mb-12">
                    <h3 className="text-xl font-black text-[#0F172A] uppercase tracking-widest mb-2">Expected Process</h3>
                    <p className="text-xs text-slate-500 font-bold tracking-widest uppercase">Your journey to digital asset ownership</p>
                </div>
